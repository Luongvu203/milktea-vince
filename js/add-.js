document.addEventListener("DOMContentLoaded", function () {
  ...
  function showDeleteSuccessOverlay() {
    ...
    if (
      ...
      containerDeleteSuccess.classList.contains("hidden")
    ) {
      var successOverlayDelete = containerDeleteSuccess.querySelector(
  ...
  clearCartButton.addEventListener("click", function () {
    var isConfirmed = confirm(
      "Bạn có chắc chắn muốn xoá tất cả sản phẩm trong giỏ hàng không?"
    );
